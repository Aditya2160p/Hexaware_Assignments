class Vehicle:
    def __init__(self, vehicleID=None, make=None, model=None, year=None, dailyRate=None,
                 status=None, passengerCapacity=None, engineCapacity=None):
    ...
    def set_dailyRate(self, dailyRate): self.__dailyRate = dailyRate
