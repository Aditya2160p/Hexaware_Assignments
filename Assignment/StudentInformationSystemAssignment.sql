...
SELECT student_id, first_name, last_name,
    (SELECT SUM(amount) FROM Payments p WHERE p.student_id = s.student_id) AS total_paid
FROM Students s;
...
SELECT course_name,
    (SELECT COUNT(student_id) FROM Enrollments e WHERE e.course_id = c.course_id) AS student_count
FROM Courses c;
...
SELECT student_id, first_name, last_name,
    (SELECT AVG(amount) FROM Payments p WHERE p.student_id = s.student_id) AS avg_payment
FROM Students s;
